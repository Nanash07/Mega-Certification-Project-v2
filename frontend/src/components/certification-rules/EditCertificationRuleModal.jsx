// src/components/certification-rules/EditCertificationRuleModal.jsx
...
export default function EditCertificationRuleModal({ open, onClose, onSaved, initial }) {
    ...
    useEffect(() => {
        if (open && initial) {
            setForm({
                ...
                certificationLevelId: initial.certificationLevelId || "",
    ...
    async function onSubmit(e) {
        ...
        setSubmitting(true);
        try {
            await updateCertificationRule(initial.id, form);
            toast.success("Aturan sertifikasi diperbarui");
            onSaved?.();
            onClose?.();
        } catch (err) {
            ...
            <div className="modal-box max-w-3xl">
                ...
                <div className="flex items-center justify-between pb-4 border-b border-gray-100">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h3 className="font-bold text-lg">Edit Aturan Sertifikasi</h3>
                            <p className="text-xs text-gray-500">Ubah aturan sertifikasi pegawai</p>
                        </div>
                    </div>
                ...
                <div className="py-5 text-sm">
                    <form id="edit-rule-form" onSubmit={onSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4">
