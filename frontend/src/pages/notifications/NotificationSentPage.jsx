...
export default function NotificationSentPage() {
    ...
    const getRecipientText = (n) => {
        ...
        const email = n.employeeEmail ? `· ${n.employeeEmail}` : "";
        return `Untuk: ${name} ${nip} ${email}`.replace(/\s+/g, " ").trim();
    };
            ...
            <div className="card bg-base-100 shadow p-6 w-full border-t-0 rounded-t-none">
                <div className="grid grid-cols-1 sm:grid-cols-4 gap-4 mb-5 text-xs">
                    <div className="flex flex-col gap-1">
                        <label className="font-semibold">Status (Penerima)</label>
                        ...
                        {rows.map((n) => (
                            ...
                            >
                                <div className="flex items-center gap-2">
                                    ...
                                    {!n.read && <span className="badge badge-primary badge-xs">Belum Dibaca</span>}
                                </div>

                                <div className="text-xs text-gray-500">{getRecipientText(n)}</div>
            ...
            {selected && (
                <dialog className="modal modal-open">
                    <div className="modal-box max-w-xl">
                        ...
                        <p className="text-xs text-gray-500 mb-3">{getRecipientText(selected)}</p>
