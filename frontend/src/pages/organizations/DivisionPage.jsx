...
import { ChevronDown, Search, Eraser, Building2 } from "lucide-react";
...
export default function DivisionPage() {
    ...
    async function load() {
        setLoading(true);
        try {
            const data = await fetchDivisions(apiParams);
    ...
    return (
        <div className="space-y-4 w-full">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                <div>
                    <h1 className="text-lg sm:text-xl font-bold">Kelola Division</h1>
                    <p className="text-xs text-gray-500">{totalElements} division terdaftar</p>
                </div>
            </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 text-xs">
                    <div className="flex flex-col gap-1 lg:col-span-3">
                        ...
                        <input
                            ...
                            placeholder="Ketik nama division..."
                        />
                    </div>
